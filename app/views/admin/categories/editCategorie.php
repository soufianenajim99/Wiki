        ...
        <div class="flex flex-row pt-24 px-10 pb-4">
            ...
            ?>
                                    <tr class="hover:bg-blue-50">
                                        ...
                                        <td class="px-6 py-4">
                                            <button>
                                                <a href="<?= URLROOT ?>categorie/editCategory/<?= $cat->category_id ?>"
                                                    class="p-2">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                </a>
                                            </button>
                                            <button>
                                                <a href="<?= URLROOT ?>categorie/deleteCategory/<?= $cat->category_id ?>"
                                                    class="p-2">
                    ...
                    <div
                        ...
                        <div class="md:flex border-l-4 border-black-800">
                            <div class="w-full px-6 py-6 md:p-8">
                                <h2 class="text-2xl font-bold text-gray-800">Editer une categorie</h2>
                                ...
                                <form class="mt-6" method="post" action="">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input
                                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            id="name" name="desc" type="text"
                                            value="<?= $data["new"]->category_desc ?>">
                                    </div>
                                    <button
